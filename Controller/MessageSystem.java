...
public class MessageSystem {
    ...
    public void userViewMessage(String username) {
        while (true) {
            ...
            programPresenter.inputPrompt("username of the other user to see your conversation");
    ...
    public void userSendMessage(String username, String userType) {
        while (true) {
            ...
            programPresenter.inputPrompt("username of the user to message");
            String otherUser = scan.nextLine();
            if (otherUser.equals("-1")) {
                break;
            }
    ...
    public void userAddContact(String username) {
        while (true) {
            ...
            programPresenter.inputPrompt("username of contact");
